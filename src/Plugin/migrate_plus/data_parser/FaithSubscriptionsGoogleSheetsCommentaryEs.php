 ...
 *
 * @DataParser(
 *   id = "faith_subscriptions_google_sheets_commentary_es",
 *   title = @Translation("Faith Subscriptions Google Sheets: Commentary (Spanish)")
 * )
 */
class FaithSubscriptionsGoogleSheetsCommentaryEs extends GoogleSheets implements ContainerFactoryPluginInterface {
  ...
  protected function getSourceData(string $url): array {
    ...
    // correct values.
    try {
      $google_sheets_api_url = \Drupal::config('faith_subscriptions_migrate.settings')->get('commentary_es_sheet_url');
