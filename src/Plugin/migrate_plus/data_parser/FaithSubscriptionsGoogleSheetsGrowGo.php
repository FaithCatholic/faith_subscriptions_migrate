 ...
 *
 * @DataParser(
 *   id = "faith_subscriptions_google_sheets_growgo",
 *   title = @Translation("Faith Subscriptions Google Sheets: Grow+Go")
 * )
 */
class FaithSubscriptionsGoogleSheetsGrowGo extends GoogleSheets implements ContainerFactoryPluginInterface {
  ...
  protected function getSourceData(string $url): array {
    ...
    // correct values.
    try {
      $google_sheets_api_url = \Drupal::config('faith_subscriptions_migrate.settings')->get('growgo_sheet_url');
