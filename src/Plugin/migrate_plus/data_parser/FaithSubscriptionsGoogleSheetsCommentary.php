 ...
 *
 * @DataParser(
 *   id = "faith_subscriptions_google_sheets_commentary",
 *   title = @Translation("Faith Subscriptions Google Sheets: Commentary")
 * )
 */
class FaithSubscriptionsGoogleSheetsCommentary extends GoogleSheets implements ContainerFactoryPluginInterface {
  ...
  protected function getSourceData(string $url): array {
    ...
    // correct values.
    try {
      $google_sheets_api_url = \Drupal::config('faith_subscriptions_migrate.settings')->get('commentary_sheet_url');
