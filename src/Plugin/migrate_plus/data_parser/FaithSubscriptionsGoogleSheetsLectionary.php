 ...
 *
 * @DataParser(
 *   id = "faith_subscriptions_google_sheets_lectionary",
 *   title = @Translation("Faith Subscriptions Google Sheets: Lectionary")
 * )
 */
class FaithSubscriptionsGoogleSheetsLectionary extends GoogleSheets implements ContainerFactoryPluginInterface {
  ...
  protected function getSourceData(string $url): array {
    ...
    // correct values.
    try {
      $google_sheets_api_url = \Drupal::config('faith_subscriptions_migrate.settings')->get('lectionary_sheet_url');
